...
import l3c.vis.histogram_plot
import l3c.vis.summarizable_module
from l3c.dataloaders.images_loader import resize_bicubic_batch
from l3c.modules import edsr
from l3c.modules.quantizer import Quantizer
...
class BicubicDownsamplingEnc(l3c.vis.summarizable_module.SummarizableModule):
    def __init__(self, *_):
...
class EDSRLikeEnc(l3c.vis.summarizable_module.SummarizableModule):
    def __init__(self, config_ms, scale):
        ...
        if self.training:
            to_q.append(
                ...
                l3c.vis.histogram_plot.HistogramPlot('train', 'histo/enc_{}_after_1x1'.format(scale+1), buffer_size=10,
