...
from l3c.helpers.paths import has_image_ext
from l3c.helpers.testset import Testset
...
class ImagesCached(object):
    ...
    def __init__(self, images_spec, cache_p=None, min_size=None):
        ...
        self.cache_p = None if cache_p is None else os.path.expanduser(cache_p)
