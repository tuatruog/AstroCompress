...
def get_config():
    ...
    # Data.
    common_data_cfg = dict(data_spec='sdss-3t',
    ...
    eval_data.chunk_size = 16  # For chunking up a large batch of patches and avoid OOM.

    # Train and eval.
    config.training = training = ml_collections.ConfigDict()
    training.n_steps = 1000000
    training.log_metrics_every_steps = 200
    ...
    optim.reduce_lr_after = 0.7 * training.n_steps
