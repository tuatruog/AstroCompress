...
def get_config():
    ...
    evaluate.use_ema = False  # whether to use EMA params for eval
    ...
    optim.reduce_lr_after = 0.8 * training.n_steps
...
def get_hyper():
    ...
    data_specs = ['sdss', 'jwst']
    data_specs = hyper.izip(hyper.sweep('train_data', data_specs),
                            hyper.sweep('eval_data', data_specs))
