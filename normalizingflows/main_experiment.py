...
parser = argparse.ArgumentParser(description='PyTorch Discrete Normalizing normalizingflows')
...
parser.add_argument('--n_flows', type=int, default=8,
                    help='number of normalizingflows per level')
...
def run(args, kwargs):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch < 25 or epoch % args.evaluate_interval_epochs == 0:
            ...
            print('(BEST: fits bpd {:.4f}, test bpd {:.4f})\n'.format(
